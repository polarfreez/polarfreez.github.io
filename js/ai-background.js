...
// Function to create and append a diamond element
...
// Function to animate the diamonds
function animate() {
...
// Create a promise to wait for the for loop to finish
const promise = new Promise((resolve, reject) => {
  // Loop through the number of diamonds
  for (let i = 0; i < numDiamonds; i++) {
    // Create and append a diamond element
    createDiamond();
  }
...
// Call the animation function after the promise is resolved
promise.then(() => {
